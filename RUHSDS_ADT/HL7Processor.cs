...
namespace RUHSDS_ADT
{
    class HL7Processor : IDisposable
    {
        ...
        public HL7Processor()
        {
            //oConn = new SqlConnection(RUHSDS_ADT.Properties.Settings.Default.connectionStr);
            oConn = new SqlConnection(ConfigurationManager.ConnectionStrings["RUHSDS_ADT.Properties.Settings.connectionStr"].ConnectionString);
